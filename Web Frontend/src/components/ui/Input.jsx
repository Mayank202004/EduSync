...
const Input = ({
  ...
  return (
    <label className={cn(labelStyle)}>
      ...
      <input
        className={cn(
          "focus:outline-none focus:ring-2 focus:ring-blue-400 not-focus:border p-2 w-full my-1.5 rounded-sm text-black dark:text-white invalid:border-red-500 invalid:focus:ring-red-500",
          inputStyle,
