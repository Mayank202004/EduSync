...
const TicketInbox = ({ onBackPressed }) => {
  ...
  return (
    <div className="bg-white dark:bg-customDarkFg border p-6 rounded-xl shadow-sm text-gray-900 dark:text-white max-w-5xl mx-auto h-full w-full px-4 flex flex-col overflow-hidden">
