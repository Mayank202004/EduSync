...
const Fees = () => {
  ...
  return (
    <div className="tablet:flex h-full w-full px-4  bg-customLightBg dark:bg-zinc-950">
      {/* Left Sidebar */}
      ...
      {isLoading ? (
        ...
        <div className="tablet:min-w-[65%] p-4 tablet:mr-0 w-full tablet:h-full border-x overflow-auto pb-10">
